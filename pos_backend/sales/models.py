...
class Return(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    sale = models.ForeignKey(Sale, on_delete=models.CASCADE, related_name='returns', verbose_name="عملية البيع")
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='processed_returns', verbose_name="الموظف")
    cash_register = models.ForeignKey(
        'CashRegister',
        on_delete=models.SET_NULL,
        null=True,
...
class ReturnItem(models.Model):
    ...
    sale_item = models.ForeignKey(SaleItem, on_delete=models.CASCADE, verbose_name="عنصر الفاتورة")
    product = models.ForeignKey('products.Product', on_delete=models.SET_NULL, null=True, verbose_name="المنتج")
    ...
    def __str__(self):
        product_name = self.product.name if self.product else self.sale_item.product_name
